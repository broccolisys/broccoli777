                ...
                if input_sentence == "인적사항조회" or input_sentence == "1":
                    while True:
                        ...
                        if personal_sentence == "0":
                            ...
                            for i in range(len(open_json_file())):
                                if personal_sentence == open_json_file()[i]["학생ID"] or personal_sentence == \
                                        open_json_file()[i]["학생정보"]["이름"] or personal_sentence == \
                                        open_json_file()[i]["학생정보"]["나이"] or personal_sentence == \
                                        open_json_file()[i]["학생정보"]["주소"]:
                                    print("\n")
                                    print((("\t" * 13) + "학생ID: %s\n" % open_json_file()[i]["학생ID"]) + "\n" +
                                          (("\t" * 12) + "이름: %s" % open_json_file()[i]["학생정보"]["이름"]) + "\n" +
                                          (("\t" * 12) + "나이: %s" % open_json_file()[i]["학생정보"]["나이"]) + "\n" +
                                    ...
                                    for x in range(len(open_json_file()[i]["수강정보"]) - 1):
                                        print((("\t" * 14) + "강좌" + str(x + 1)) + "\n\n" +
                                              ...
                                              (("\t" * 13) + "종료일" + str(x + 1) + ": " + "%s" %
                                               open_json_file()[i]["수강정보"]["강좌" + str(x)]["종료일"]) + "\n")
                                        continue
                            if not personal_sentence == open_json_file()[i]["학생ID"] or not personal_sentence == \
                                                                                           open_json_file()[i]["학생정보"][
                                                                                               "이름"] or not personal_sentence == \
                                                                                                            open_json_file()[
                                                                                                                i][
                                                                                                                "학생정보"][
                                                                                                                "나이"] or not personal_sentence == \
                                                                                                                             open_json_file()[
                                                                                                                                 i][
                                                                                                                                 "학생정보"][
                                                                                                                                 "주소"]:
                ...
                if input_sentence == "수강정보조회" or input_sentence == "3":
                    while True:
                        ...
                        if institute_sentence == "0":
                            ...
                            for i in range(len(open_json_file())):
                                for x in range(len(open_json_file()[i]["수강정보"]) - 1):
                                    if institute_sentence == open_json_file()[i]["수강정보"][
                                        "과거수강횟수"] or institute_sentence == open_json_file()[i]["수강정보"]["강좌" + str(x)][
                                        "강의코드"] or institute_sentence == open_json_file()[i]["수강정보"]["강좌" + str(x)][
                                        "강의명"] or institute_sentence == open_json_file()[i]["수강정보"]["강좌" + str(x)][
                                        "강사"]:
                                        print("\n")
                                        print((("\t" * 13) + "학생ID: %s\n" % open_json_file()[i]["학생ID"]) + "\n" +
                                              (("\t" * 12) + "이름: %s" % open_json_file()[i]["학생정보"]["이름"]) + "\n" +
                                              (("\t" * 12) + "나이: %s" % open_json_file()[i]["학생정보"]["나이"]) + "\n" +
                                              (("\t" * 12) + "주소: %s" % open_json_file()[i]["학생정보"]["주소"]) + "\n\n" +
                                              (("\t" * 13) + "과거수강횟수: %s" % open_json_file()[i]["수강정보"][
                                                  "과거수강횟수"]) + "\n")
                                        print((("\t" * 14) + "강좌" + str(x + 1)) + "\n\n" +
                                              (("\t" * 13) + "강의코드" + str(x + 1) + ": " + "%s" %
                                               open_json_file()[i]["수강정보"]["강좌" + str(x)]["강의코드"]) + "\n" +
