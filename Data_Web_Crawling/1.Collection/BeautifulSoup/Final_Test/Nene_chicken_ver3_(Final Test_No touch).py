...
if os.path.isfile(dir_name + dir_delimeter + "count.txt"):
    ...
    destination_file = dir_name + dir_delimeter + sdir_nene + str(dir_n) + dir_delimeter + file_nene + str(count_n) +"_"+ now_time+ csv
    ...
    init_file = dir_name + dir_delimeter + sdir_nene + "1" + dir_delimeter + file_nene + "1" +"_"+ now_time +csv
